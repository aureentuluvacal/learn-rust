// Modules can be nested like files in directories.
// By default, modules, their functions and its contents
// are private. We need to add the keyword "pub" to make it accessible.
